...
- The user invokes one bounded update through `寵物醒來` or `Memoryling, wake up` in an Agent project. Project／Agent wake-up requests do not grant this authorization.
