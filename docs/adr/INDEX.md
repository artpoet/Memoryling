...
| ADR | Decision | Status |
|---|---|---|
| [0001](0001-local-first-derived-memory.md) | Local-first, lineage-aware derived memory | Accepted |
| [0002](0002-sqlite-v1-fixture-first-memory.md) | SQLite v1 local lineage store and fixture-only first-memory pilot | Accepted |
...
| [0009](0009-conversation-first-pet-wake.md) | Agent conversation is the primary control surface and wakes the pet | Accepted |
