...
The paired eyes are a single synchronized motion unit: their primary ellipses share one vertical center, sit at `x=95／145` with the original `rx=10／ry=14` size in the 240-unit viewBox, and blink together. The retained eye breathing room, shorter eye-to-mouth gap, prominent memory core, outward leaf sprouts, and four continuous plates that hug the cheeks and meet at the base are deliberate juvenile／cute proportions from the accepted concept. Do not combine inward eye movement with larger eye ellipses: that removes the central breathing room and makes the face feel crowded. Also do not reintroduce independent eye timing, per-eye transforms, asymmetrical offsets, or detached necklace-like lower petals. On the compact pet surface, the required memory-access-off truth remains visible as quiet inline text rather than a pill, button, card, shadow, or other interactive-looking control.
