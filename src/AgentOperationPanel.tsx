...
const copy = {
  en: {
    ...
    title: "Open Memoryling, then say “Run Memoryling” in your agent project",
    intro:
    ...
    waitingBody: "Return to your Agent project and say “Run Memoryling” to begin the next update.",
  ...
  "zh-TW": {
    ...
    title: "先打開 Memoryling，再回 Agent 專案說：「運作 Memoryling」",
    intro:
    ...
    waitingBody: "回到你的 Agent 專案，輸入「運作 Memoryling」即可開始下一次更新。",
