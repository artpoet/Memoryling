...
const copy = {
  en: {
    ...
    noSignalsBody: "Keep this app open, then say “Run Memoryling” in your Agent project to create the first update package.",
  ...
  "zh-TW": {
    ...
    memoryLabel: "記憶訊號",
    noSignals: "尚無具來源鏈的訊號",
    noSignalsBody: "請讓 App 保持開啟，再回 Agent 專案說「運作 Memoryling」，建立第一份更新包。",
